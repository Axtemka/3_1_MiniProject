...
public class Story {
    ...
    public Story() {
        this.startEvent = new Event("В первый рабочий день босс вызывает вас к себе и говорит:\nТак, новичек, подойди сюда, дело есть. У меня для тебя есть несколько заданий, но так как ты первый денб работаешь, возми одно на выбор:\n" +
